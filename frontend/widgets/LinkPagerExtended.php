 ...
 * @since 2.0
 */
class LinkPagerExtended extends Widget
{
    /**
    ...
    public $tagWrapper = 'ul';
    
    public $tagWrapperItem = 'li';
    
    public $disableWrappenItem = false;
    ...
    protected function renderPageButtons()
    {
        ...
        return Html::tag($this->tagWrapper, implode("\n", $buttons), $this->options);
    }
    ...
    protected function renderPageButton($label, $page, $class, $disabled, $active)
    {
        ...
        if(!$this->disableWrappenItem)
            return Html::tag($this->tagWrapperItem, Html::a($label, $this->pagination->createUrl($page), $linkOptions), $options);    
        else
